        ...
        <% String requestId =request.getParameter("requestId");%>
            <form action="ConfirmBookRequest.do">
                <div class="center_align">
                    <h1>
                        <strong> Confirm Book Request </strong>
                    </h1>
                </div>
                <label class="center_align"> <h3> Enter Book RequestId </h3> </label>
                <div class="input_container">
                    <input type="text" class="input_style" name="requestId" value="<%=requestId%>" readonly required />
                </div>
                <div class="center_align">
